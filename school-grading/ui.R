    ...
    fluidRow(
        column(8, offset = 2,
            ...
            hidden(div(id = "heatmap",
                ...
                tableOutput("heatmap"),
                br(),
                p("Your school's", strong("Achievement Grade"), "is the better of the",
                ...
                p("Your school's", strong("Readiness Grade"), "is the better of the",
                    strong("Readiness"), "and", strong("Readiness Target"), "grades."),
                p("Your school's", strong("ELPA Grade"), "is the better of the",
                    strong("ELPA Exit"), "and", strong("ELPA Growth Standard"), "grades."),
                p("Your school's", strong("Absenteeism Grade"), "is the better of the",
